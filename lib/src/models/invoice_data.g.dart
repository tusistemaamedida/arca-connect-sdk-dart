...
_$IvaItemImpl _$$IvaItemImplFromJson(Map<String, dynamic> json) =>
    _$IvaItemImpl(
...
Map<String, dynamic> _$$IvaItemImplToJson(_$IvaItemImpl instance) =>
    <String, dynamic>{
...
_$InvoiceDataImpl _$$InvoiceDataImplFromJson(Map<String, dynamic> json) =>
    _$InvoiceDataImpl(
      ...
      iva: (json['iva'] as List<dynamic>?)
              ?.map((e) => IvaItem.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const <IvaItem>[],
    );

Map<String, dynamic> _$$InvoiceDataImplToJson(_$InvoiceDataImpl instance) =>
    <String, dynamic>{
